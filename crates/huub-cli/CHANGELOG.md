...
## [101.0.0](https://github.com/huub-solver/huub/compare/huub-cli-v100.1.0...huub-cli-v101.0.0) - 2026-09-01

### Added

- output internal objective in the statistics
...
- *(xtask)* compile the CLI definition instead of linking huub-cli
