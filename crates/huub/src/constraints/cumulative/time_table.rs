//! Time-table propagation for the `cumulative` constraint: building the
...
use crate::{
	actions::{
		IntDecisionActions, IntInspectionActions, PropagationContext, ReasonActions,
		ReasoningContext, ReasoningEngine,
	},
	constraints::{
		IntSolverActions,
		cumulative::{CumulativePropagationRule, CumulativePropagator},
	},
...
impl<I1, I2, I3, I4> CumulativePropagator<I1, I2, I3, I4> {
	...
	pub(super) fn build_profile_and_check_overload<E>(
		&mut self,
	...
	/// amount of energy at a specific time point.
