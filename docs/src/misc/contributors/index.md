...
The Huub project welcomes contributions from the community.
Whether you're interested in improving the solver, adding new features, fixing bugs, or improving documentation, we'd love to have you involved.
Please visit the [GitHub repository](https://github.com/huub-solver/huub) to get started.
